...
def main():
    ...
    def countWheneverRangesOverlap(i, rangePair):
        return i + rangePair.rangesOverlap()

    res = reduce(
        countWheneverRangesOverlap,
        assignmentPairs,
        0
    )
...
class SectionRangePair:
    ...
    def rangesOverlap(self):
        return len(set(self.leftRange) & set(self.rightRange)) > 0
